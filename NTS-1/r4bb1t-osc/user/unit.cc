...
__unit_callback void unit_set_param_value(uint8_t id, int32_t value) {
  ...
  case MODTYPE:
    value = clipminmaxi32(0, value, NUM_MODTYPE_VALUES -1);
  default:
    break;
  }
}
...
__unit_callback const char* unit_get_param_str_value(uint8_t id, int32_t value) {
  ...
  static const char* modTypeStrings[NUM_MODTYPE_VALUES] = {
    "AM",
    "FM",
    "PM"
  };
  ...
  case TYP2:
    ...
    break;
  case MODTYPE:
    if (value >= AM && value < NUM_MODTYPE_VALUES)
      return modTypeStrings[value];
  default:
    break;
  }
